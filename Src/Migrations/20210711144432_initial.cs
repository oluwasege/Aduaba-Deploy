        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CCV = table.Column<string>(nullable: false),
                    ApplicationUserId = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShoppingCartSegs", x => x.ShoppingCartId);
                    table.ForeignKey(
                        name: "FK_ShoppingCartSegs_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WishListSegs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WishListSegs_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastName = table.Column<string>(nullable: true),
                    PhoneNumber = table.Column<string>(nullable: true),
                    OrderStatusId1 = table.Column<string>(nullable: true),
                    OrderStatusId = table.Column<int>(nullable: false),
                    PaymentType = table.Column<string>(nullable: true),
                    OrderDate = table.Column<DateTime>(nullable: false),
                    OrderReferenceNumber = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "WishListItemSegs",
                columns: table => new
                {
                    WishListItemId = table.Column<string>(nullable: false),
                    WishListId = table.Column<string>(nullable: true),
                    ProductId = table.Column<string>(nullable: true),
                    WishListSegId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WishListItemSegs", x => x.WishListItemId);
                    table.ForeignKey(
                        name: "FK_WishListItemSegs_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WishListItemSegs_WishListSegs_WishListSegId",
                        column: x => x.WishListSegId,
                        principalTable: "WishListSegs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShoppingCartSegShoppingCartId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartItemSegs", x => x.CartItemId);
                    table.ForeignKey(
                        name: "FK_CartItemSegs_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CartItemSegs_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "OrderId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CartItemSegs_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CartItemSegs_ShoppingCartSegs_ShoppingCartSegShoppingCartId",
                        column: x => x.ShoppingCartSegShoppingCartId,
                        principalTable: "ShoppingCartSegs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartItemSegs_ApplicationUserId",
                table: "CartItemSegs",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_CartItemSegs_OrderId",
                table: "CartItemSegs",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_CartItemSegs_ProductId",
                table: "CartItemSegs",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_CartItemSegs_ShoppingCartSegShoppingCartId",
                table: "CartItemSegs",
                column: "ShoppingCartSegShoppingCartId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingCartSegs_ApplicationUserId",
                table: "ShoppingCartSegs",
                column: "ApplicationUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WishListItemSegs_ProductId",
                table: "WishListItemSegs",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_WishListItemSegs_WishListSegId",
                table: "WishListItemSegs",
                column: "WishListSegId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WishListSegs_ApplicationUserId",
                table: "WishListSegs",
                column: "ApplicationUserId");
        }
