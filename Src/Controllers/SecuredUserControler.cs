   ...
   // [Route("api/[controller]")]
    ...
    public class SecuredUserController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<Product>>> Search(string name)
        {
            try
            {
                var result = await _search.SearchProduct(name);
        ...
        public async Task<ActionResult<IEnumerable<Product>>> SearchVendors(string name)
        {
            try
            {
                var result = await _search.SearchVendor(name);
